...
const topPositionMesh4:dataAnimation = {
    position:{
        x:1.84,
        y:2.16,
        z:0
...
const bottomPositionMesh4:dataAnimation = {
    position:{
        x:1.83,
        y:1.87,
        z:0
...
const stepsMesh4:dataAnimation = {
    position:{
...
const topPositionMesh5:dataAnimation = {
    position:{
        x:3.78,
        y:2.43,
        z:0
...
const bottomPositionMesh5:dataAnimation = {
    position:{
        x:3.67,
        y:1.43,
        z:0
...
const stepsMesh5:dataAnimation = {
    position:{
